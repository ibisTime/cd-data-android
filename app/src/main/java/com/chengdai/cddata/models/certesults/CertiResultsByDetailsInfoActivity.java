...
public class CertiResultsByDetailsInfoActivity extends AbsBaseActivity {

    private ActivityDetailsInfoResultsBinding mBinding;

    private FraudNumCheckModel mData;
     ...
     * @param context
     */
    public static void open(Context context, boolean issuccessful, FraudNumCheckModel data, String info) {
        if (context == null) {
            return;
        }
        Intent intent = new Intent(context, CertiResultsByDetailsInfoActivity.class);
    ...
    public void afterCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("issuccessful", false)) {
            ...
            if (mData != null && mData.getVerifyInfoList()!=null) {

                StringBuffer sb = new StringBuffer();

                for (String s : mData.getVerifyInfoList()) {
                    sb.append(s);
                    sb.append("\n\n");
                }
